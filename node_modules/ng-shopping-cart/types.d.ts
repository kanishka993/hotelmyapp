 ...
 */
export declare type AddToCartType = 'button' | 'dropdown' | 'text' | 'number';
/**
 ...
 */
export declare type AddToCartPosition = 'top' | 'bottom' | 'left' | 'right';
/**
 ...
 */
export declare type CartViewDisplay = 'table' | 'responsive-table' | 'fixed';
/**
 ...
 */
export declare type CheckoutType = 'log' | 'http' | 'paypal';
/**
 ...
 */
export declare type CheckoutSettings = null | CheckoutHttpSettings | CheckoutPaypalSettings;
/**
 ...
 */
export declare type CartModuleServiceType = 'memory' | 'localStorage' | 'sessionStorage';
