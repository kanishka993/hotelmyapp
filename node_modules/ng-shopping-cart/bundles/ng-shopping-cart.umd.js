(function (global, factory) {
	...
	(factory((global['ng-shopping-cart'] = {}),global.ng.core,global.ng.common,global.ng.common.http));
...
var CartService = /** @class */ (function () {
    function CartService() {
        ...
        this.onItemAdded = new core.EventEmitter();
        this.onItemRemoved = new core.EventEmitter();
        this.onItemsChanged = new core.EventEmitter();
        this.onTaxChange = new core.EventEmitter();
        this.onShippingChange = new core.EventEmitter();
    }
...
var CartCheckoutComponent = /** @class */ (function () {
    function CartCheckoutComponent(cartService, httpClient, locale) {
        ...
        this.getLocaleCurrencyName = common.getLocaleCurrencyName;
    }
    ...
    CartCheckoutComponent.prototype.getCurrency = function (locale) {
        ...
        var fmt = new common.CurrencyPipe(locale);
            ...
            case 'http':
                ...
                if (options && options.headers && options.headers.has('Content-Type')) {
                    ...
                    if (contentType.startsWith('application/x-www-form-urlencoded')) {
                        cart = new http.HttpParams({ fromObject: cart });
                    }
                }
                this.httpClient
                    .request(new http.HttpRequest(methodUpper, url, cart, options))
                    .toPromise()
...
CartCheckoutComponent.propDecorators = {
    ...
    "localeFormat": [{ type: core.Input },],
    "checkout": [{ type: core.Output },],
...
CartSummaryComponent.propDecorators = {
    ...
    "oneItemText": [{ type: core.Input },],
    "manyItemsText": [{ type: core.Input },],
    "localeFormat": [{ type: core.Input },],
};
...
CartViewComponent.propDecorators = {
    ...
    "customEmptyContent": [{ type: core.Input },],
    "nameHeaderText": [{ type: core.Input },],
    "quantityHeaderText": [{ type: core.Input },],
    "priceHeaderText": [{ type: core.Input },],
    "totalHeaderText": [{ type: core.Input },],
    "taxFooterText": [{ type: core.Input },],
    "shippingFooterText": [{ type: core.Input },],
    "totalFooterText": [{ type: core.Input },],
    "localeFormat": [{ type: core.Input },],
};
...
CartShowcaseComponent.propDecorators = {
    "xsCols": [{ type: core.Input },],
    "sCols": [{ type: core.Input },],
    "mCols": [{ type: core.Input },],
    "lCols": [{ type: core.Input },],
    "xlCols": [{ type: core.Input },],
    "columns": [{ type: core.Input },],
    "items": [{ type: core.Input },],
    "itemComponent": [{ type: core.Input },],
    "injector": [{ type: core.Input },],
    "moduleFactory": [{ type: core.Input },],
...
ShowcaseOutletDirective.propDecorators = {
    "cartShowcaseOutlet": [{ type: core.Input },],
    "cartShowcaseOutletInjector": [{ type: core.Input },],
    "cartShowcaseOutletNgModuleFactory": [{ type: core.Input },],
    "cartShowcaseOutletItem": [{ type: core.Input },],
    "cartShowcaseOutletFormat": [{ type: core.Input },],
};
var CART_ITEM_CLASS = new core.InjectionToken('CartItemClass');
var CART_SERVICE_CONFIGURATION = new core.InjectionToken('CartServiceConfiguration');
var CART_SERVICE_TYPE = new core.InjectionToken('CartServiceType');
...
BrowserStorageCartService.ctorParameters = function () { return [
    { type: CartItem, decorators: [{ type: core.Inject, args: [CART_ITEM_CLASS,] },] },
    { type: undefined, decorators: [{ type: core.Inject, args: [CART_SERVICE_CONFIGURATION,] },] },
]; };
...
LocalStorageCartService.ctorParameters = function () { return [
    { type: undefined, decorators: [{ type: core.Inject, args: [CART_ITEM_CLASS,] },] },
    { type: undefined, decorators: [{ type: core.Inject, args: [CART_SERVICE_CONFIGURATION,] },] },
]; };
...
var CartCurrencyPipe = /** @class */ (function () {
    function CartCurrencyPipe(_locale) {
        ...
        this.currencyFormatter = new common.CurrencyPipe(this._locale);
    }
...
CartCurrencyPipe.decorators = [
    { type: core.Pipe, args: [{ name: 'cartCurrency' },] },
];
...
exports.CartCheckoutComponent = CartCheckoutComponent;
exports.CartSummaryComponent = CartSummaryComponent;
exports.CartShowcaseComponent = CartShowcaseComponent;
exports.CartShowcaseItemComponent = CartShowcaseItemComponent;
exports.CartViewComponent = CartViewComponent;
exports.CartCurrencyPipe = CartCurrencyPipe;
exports.ShoppingCartModule = ShoppingCartModule;
exports.CART_ITEM_CLASS = CART_ITEM_CLASS;
exports.CART_SERVICE_CONFIGURATION = CART_SERVICE_CONFIGURATION;
exports.CART_SERVICE_TYPE = CART_SERVICE_TYPE;
exports.CartService = CartService;
exports.MemoryCartService = MemoryCartService;
exports.LocalStorageCartService = LocalStorageCartService;
exports.SessionStorageCartService = SessionStorageCartService;
exports.CartItem = CartItem;
exports.BaseCartItem = BaseCartItem;
exports.parseLocaleFormat = parseLocaleFormat;
exports.ɵa = AddToCartEditorComponent;
exports.ɵb = ShowcaseOutletDirective;
exports.ɵc = serviceFactory;
exports.ɵe = setItemClass;
exports.ɵf = setServiceConfiguration;
exports.ɵd = setupService;
exports.ɵg = BrowserStorageCartService;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ng-shopping-cart.umd.js.map
